...
def genetic_algorithm_defaults(n: int) -> Dict[str, Any]:
    return {
        "population_size": max(60, min(120, n)),
        "max_generations": max(240, min(600, int(1.5 * n))),
        "crossover_rate": 0.88,
        "mutation_rate": min(0.05, 3.0 / max(n, 1)),
        "elite_count": 2,
        "crossover_mode": "uniform",
        "tournament_size": 3,
        "local_search_every": 6,
        "local_search_steps": max(12, n // 10),
        "local_search_noise_probability": 0.15,
        "annealing_temperature": 2.2,
        "annealing_cooling": 0.992,
        "annealing_trials": 1,
        "annealing_unsatisfied_focus_probability": 0.75,
        "stagnation_limit": 24,
        "reheat_multiplier": 1.5,
        "initialization_strategy": "polarity",
        "polarity_bias_strength": 0.7,
        "multi_bit_mutation_probability": 0.02,
